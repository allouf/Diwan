import { PrismaClient, UserRole, Priority, SenderType, DocumentStatus, OutcomeType } from '@prisma/client';
...
async function main() {
  ...
  const sampleDocs = [
    ...
    {
      referenceNumber: `HIAST-${year}-00006`,
      subject: 'Employee Performance Review Process Update',
      summary: 'Revised performance review framework for all staff members including new evaluation criteria and timeline.',
    ...
    {
      referenceNumber: `HIAST-${year}-00007`,
      subject: 'Student Scholarship Program for 2024-2025',
      summary: 'Annual scholarship program announcement for outstanding students with eligibility criteria and application procedures.',
      senderName: 'Ministry of Higher Education',
      category: academicCategory,
      departments: [academicDept, financeDept],
      priority: Priority.HIGH,
      status: DocumentStatus.PENDING,
    },
    {
      referenceNumber: `HIAST-${year}-00008`,
      subject: 'Lab Equipment Procurement Request',
      summary: 'Request for procurement of advanced laboratory equipment for the engineering department including specifications and budget.',
      senderName: 'Engineering Department Head',
      category: financialCategory,
      departments: [financeDept, researchDept],
      priority: Priority.NORMAL,
      status: DocumentStatus.IN_PROGRESS,
    },
    {
      referenceNumber: `HIAST-${year}-00009`,
      subject: 'Annual Fire Safety Inspection Report',
      summary: 'Results of the annual fire safety inspection with recommendations for improvements and compliance requirements.',
      senderName: 'National Safety Authority',
      category: administrativeCategory,
      departments: [itDept, hrDept],
      priority: Priority.URGENT,
      status: DocumentStatus.PENDING,
    },
    {
      referenceNumber: `HIAST-${year}-00010`,
      subject: 'International Conference Participation Approval',
      summary: 'Request for approval and funding for faculty participation in the International Technology Conference in Dubai.',
      senderName: 'Dr. Ahmad Khalil',
      category: researchCategory,
      departments: [researchDept, financeDept],
      priority: Priority.NORMAL,
      status: DocumentStatus.COMPLETED,
    },
    {
      referenceNumber: `HIAST-${year}-00011`,
      subject: 'Building Maintenance Contract Renewal',
      summary: 'Renewal of annual building maintenance contract including cleaning, security, and facility management services.',
      senderName: 'Facilities Management Company',
      category: administrativeCategory,
      departments: [financeDept],
      priority: Priority.NORMAL,
      status: DocumentStatus.DRAFT,
    },
    {
      referenceNumber: `HIAST-${year}-00012`,
      subject: 'Data Privacy Compliance Update',
      summary: 'Implementation of updated data privacy regulations and GDPR compliance measures for student and staff records.',
      senderName: 'Legal Compliance Office',
      category: legalCategory,
      departments: [legalDept, itDept],
      priority: Priority.HIGH,
      status: DocumentStatus.IN_PROGRESS,
    },
    {
      referenceNumber: `HIAST-${year}-00013`,
      subject: 'Summer Training Program Partnership',
      summary: 'Proposal for summer training program partnership with leading technology companies for student internships.',
      senderName: 'Corporate Relations Office',
      category: academicCategory,
      departments: [academicDept, hrDept],
      priority: Priority.NORMAL,
      status: DocumentStatus.PENDING,
    },
    {
      referenceNumber: `HIAST-${year}-00014`,
      subject: 'Network Infrastructure Upgrade Phase 2',
      summary: 'Second phase of campus-wide network infrastructure upgrade including fiber optic installation and WiFi expansion.',
      senderName: 'IT Infrastructure Team',
      category: technicalCategory,
      departments: [itDept, financeDept],
      priority: Priority.HIGH,
      status: DocumentStatus.IN_PROGRESS,
    },
    {
      referenceNumber: `HIAST-${year}-00015`,
      subject: 'Academic Calendar 2024-2025',
      summary: 'Proposed academic calendar for the upcoming academic year including exam periods, holidays, and important deadlines.',
      senderName: 'Dean of Academic Affairs',
      category: academicCategory,
      departments: [academicDept],
      priority: Priority.URGENT,
      status: DocumentStatus.COMPLETED,
    },
  ];
